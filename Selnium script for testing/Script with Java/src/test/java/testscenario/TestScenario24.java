...
public class TestScenario24 {
    public static void executeTest24() {
        /*
        ...
        try {
            ...
            driver.findElement(By.name("password_field")).sendKeys("test_data_784");
            driver.findElement(By.id("checkout_btn")).sendKeys("test_data_661");
            ...
            driver.findElement(By.id("user_name")).sendKeys("test_data_507");
            if (!driver.findElement(By.className("nav-item")).isDisplayed()) {
                System.out.println("Element not displayed");
            }
            driver.findElement(By.cssSelector(".promo-code")).sendKeys("test_data_424");
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            driver.quit();
