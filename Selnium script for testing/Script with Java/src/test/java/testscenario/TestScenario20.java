...
public class TestScenario20 {
    public static void executeTest20() {
        /*
        ...
        try {
            ...
            driver.findElement(By.xpath("//button[@type='submit']")).sendKeys("test_data_962");
            driver.findElement(By.name("password_field")).sendKeys("test_data_461");
            ...
            driver.findElement(By.id("user_name")).sendKeys("test_data_194");
            if (!driver.findElement(By.cssSelector(".promo-code")).isDisplayed()) {
                System.out.println("Element not displayed");
            }
        } catch (Exception e) {
