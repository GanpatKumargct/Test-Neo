...
public class TestScenario5 {
    public static void executeTest5() {
        ...
        try {
            ...
            driver.findElement(By.linkText("Log Out")).sendKeys("test_data_899");
            if (!driver.findElement(By.name("password_field")).isDisplayed()) {
                System.out.println("Element not displayed");
            }
            if (!driver.getTitle().contains("Dashboard")) {
            ...
            driver.findElement(By.className("nav-item")).sendKeys("test_data_395");
            driver.findElement(By.id("user_name")).sendKeys("test_data_951");
            if (!driver.findElement(By.linkText("Log Out")).isDisplayed()) {
                System.out.println("Element not displayed");
            }
            driver.findElement(By.id("user_name")).sendKeys("test_data_728");
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            driver.quit();
